...
export default function toogleTheme(e,targetTheme){
    ...
    if(targetTheme===false){
        ...
        rootElement.setProperty('--primary-background','hsl(0, 0%, 98%)')
        rootElement.setProperty('--screen-background','hsl(236, 33%, 92%)')
        rootElement.setProperty('--primary-font','hsl(233, 11%, 84%)')
        rootElement.setProperty('--primary-font-hover','hsl(233, 11%, 84%)')
        rootElement.setProperty('--icons-color','hsl(235, 19%, 35%)')
        rootElement.setProperty('--icons-weigth-color','hsl(233, 11%, 84%)')
